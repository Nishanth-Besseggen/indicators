...
/**
	 ...
	 * @returns 
	 */
export async function normalize(originalLength: number, source: Array<number> | string, empty = NaN): Promise<Array<number>> {
 ...
 * @returns 
 */
export async function crossany(a: number[], b: number[], size: number = a.length) {
 ...
 * @returns 
 */
export async function hma(input: number[], period: number, size=input.length): Promise<Array<number>> {
 ...
 * @returns 
 */
export async function linregintercept(
	source: Array<number>, period: number,
	size: number = source.length
): Promise<Array<number>> {
 ...
 * @returns 
 */
export async function linregslope(
	source: Array<number>, period: number,
	size: number = source.length
): Promise<Array<number>> {
 ...
 * @returns 
 */
export async function zlema(input: number[], period: number, size: number = input.length): Promise<number[]> {
 ...
 * @returns 
 */
export async function copp(data: number[], period1: number, period2: number): Promise<number[]> {
 ...
 * @param period 
 */
export async function dc(highs: number[], lows: number[], period: number): Promise<[number[], number[], number[]]> {
